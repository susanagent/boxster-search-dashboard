...
export const SOURCES: Source[] = [
  source("craigslist", "Craigslist regional searches", "marketplace", "https://www.craigslist.org", "primary", "Search multiple regional centers; verify the vehicle detail page.", { listingsScanned: 13, activeListingsVerified: 13, uniqueCandidates: 6, promotedCandidates: 6, duplicateRate: 0, lastSuccessfulCheck: "2026-08-18" }),
  ...
  source("club-manual", "Club Manual", "marketplace", "https://clubmanual.com/vehicles/porsche/boxster", "primary", "Manual-only discovery source with accessible structured detail pages; verify originating dealer inventory.", { listingsScanned: 15, activeListingsVerified: 2, uniqueCandidates: 1, promotedCandidates: 1, lastSuccessfulCheck: "2026-08-18" }),
